...
| 2020.11.08 | N1, S905x3 | TOOL | ✩✩✩ | [dtb-amlogic](https://github.com/ophub/amlogic-s9xxx-openwrt/tree/main/armbian/dtb-amlogic) | The dtb library is added to facilitate the lack of corresponding boot files when compiling the firmware of related models with the old version of the kernel file. |
...
| - | All | UPDATE | ✩✩ | [s905x3-install.sh](https://github.com/ophub/amlogic-s9xxx-openwrt/blob/main/install-program/files/s905x3-install.sh) | Added that if the dtb file is missing during installation, the download path will be prompted. |
...
| 2020.11.01 | All | ADD | ✩✩✩✩✩ | [s905x3-install.sh](https://github.com/ophub/amlogic-s9xxx-openwrt/blob/main/install-program/files/s905x3-install.sh) | Added the function of writing emmc partition to s905x3 series boxes. |
| - | All | ADD | ✩✩✩✩✩ | [s905x3-update.sh](https://github.com/ophub/amlogic-s9xxx-openwrt/blob/main/install-program/files/s905x3-update.sh) | Added the function of updating emmc partition firmware to s905x3 series boxes. |
