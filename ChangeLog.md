...
| - | All | TOOL | ✩✩✩ | update_dtb.sh | [Replaced](https://github.com/ophub/amlogic-s9xxx-openwrt/blob/main/amlogic-s9xxx/amlogic-kernel/build_kernel/openwrt-kernel) . Update kernel.tar.xz files in the kernel directory with the latest dtb file. |
