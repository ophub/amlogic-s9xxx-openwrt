...
| amlogic_kernel         | 5.14.1_5.4.144         | Set the kernel version，Ophub's [kernel](https://github.com/ophub/flippy-kernel/tree/main/library) library contains many original kernels of `Flippy`, you can view and choose to specify. |
...
| -k | Kernel | Specify the kernel type. Write the kernel name individually such as `-k 5.4.144` . Multiple cores use `_` connection such as `-k 5.14.1_5.4.144` [kernel](https://github.com/ophub/flippy-kernel/tree/main/library). |
