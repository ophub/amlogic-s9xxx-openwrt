...
| -k | Kernel | Specify the kernel type. Write the kernel name individually such as `-k 5.4.145` . Multiple cores use `_` connection such as `-k 5.10.66_5.4.147` [kernel](https://github.com/ophub/flippy-kernel/tree/main/library). |
