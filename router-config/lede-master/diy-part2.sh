...
sed -i 's/root::0:0:99999:7:::/root:$1$tE.TSiJh$I7W1QPlS3Dg3GNjuSUpMK0:0:0:99999:7:::/g' /etc/shadow
...
svn checkout https://github.com/openwrt/packages/trunk/multimedia/ffmpeg feeds/packages/multimedia/ffmpeg
